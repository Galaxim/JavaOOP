...
public class Exercises {
    ...
    private static void exercise1() {
        System.out.println("\nExercise 1: ");
        Rectangle superRectangle=new Rectangle(7,4);
        Circle sun = new Circle(6,34);
        System.out.println(superRectangle.calculateArea());
        System.out.println(sun.calculateArea());
    }
    ...
    private static void exercise2() {
        System.out.println("\nExercise 2: ");
        Boat shippy= new Boat();
        Car saettaMcQueen= new Car();
        System.out.println(shippy.moveBackward());
        System.out.println(saettaMcQueen.moveForward());
    }
    ...
    private static void exercise3() {
        System.out.println("\nExercise 3: ");
        Guitar Hendrix= new Guitar("Jimi","Gibson");
        Piano Mozart= new Piano("Amadeus","Yamaha");
        //le variabili name e brand sono solo a scopo illustrativo, greg ha detto che non servono per il metodo
        System.out.println(Hendrix.play());
        System.out.println(Mozart.play());
    }
}
